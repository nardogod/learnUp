...
const messages: Record<Language, Record<string, string>> = {
  "português": {
    ...
    wordTipPrompt: 'Dica opcional para "{word}" (Enter para pular):',
  ...
  inglês: {
    ...
    wordTipPrompt: 'Optional tip for "{word}" (Enter to skip):',
  ...
  svenska: {
    ...
    wordTipPrompt: 'Valfri tips för "{word}" (Enter för att hoppa över):',
