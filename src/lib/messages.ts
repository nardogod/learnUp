...
const messages: Record<Language, Record<string, string>> = {
  "português": {
    welcome:
      "Olá! Bem-vindo ao LearnUP. Use /palavras para ver suas palavras, /frase para gerar uma frase, ou digite 'palavra nova' para cadastrar.",
    ...
    noWords: "Você ainda não tem palavras cadastradas. Digite 'palavra nova' para começar!",
    ...
    fraseLimitReached: "Você atingiu o limite de 3 frases por dia no plano free. Use /plan para ver opções.",
  ...
  inglês: {
    welcome:
      "Hello! Welcome to LearnUP. Use /palavras to see your words, /frase to generate a sentence, or type 'new word' to register one.",
    ...
    noWords: "You don't have any words yet. Type 'new word' to get started!",
    planFree: "📋 Free Plan\n• 100 words\n• 3 automatic phrases/day\n• 3 /frase per day\n\nUpgrade to premium!",
    planPremium: "📋 Premium Plan\n• Unlimited words\n• Automatic phrases: {count}/day\n• /frase unlimited",
    tryAgain: "Try again in a few minutes.",
    fraseLimitReached: "You've reached the 3 phrases per day limit on the free plan. Use /plan for options.",
  ...
  svenska: {
    welcome:
      "Hej! Välkommen till LearnUP. Använd /palavras för att se dina ord, /frase för att generera en mening, eller skriv 'nytt ord' för att registrera.",
    ...
    noWords: "Du har inga ord ännu. Skriv 'nytt ord' för att komma igång!",
    planFree: "📋 Free-plan\n• 100 ord\n• 3 automatiska fraser/dag\n• 3 /frase per dag\n\nUppgradera till premium!",
    planPremium: "📋 Premium-plan\n• Obegränsade ord\n• Automatiska fraser: {count}/dag\n• /frase obegränsat",
    tryAgain: "Försök igen om några minuter.",
    fraseLimitReached: "Du har nått gränsen på 3 fraser per dag på free-planen. Använd /plan för alternativ.",
